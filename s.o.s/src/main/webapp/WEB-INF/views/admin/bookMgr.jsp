		...
		<div id="bookModal1" class="modal">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="modal-section">
						<label class="modal-label">교재명</label>
						<input type="text" id="bookTitle1" name="bookTitle1" class="modal-input" value="윤혜정의 개념의 나비효과" />
					</div>
					<div class="modal-section">
						<label class="modal-label">과목 코드</label>
						<input type="text" id="bookclassCode1" name="bookclassCode1" class="modal-input" value="1" />
					</div>
					<div class="modal-section">
						<label class="modal-label">교재 정보</label>
						<input type="text" id="bookInfo1" name="bookInfo1" class="modal-input" value="EBS 윤혜정의 개념의 나비효과 입문 편 워크북 독서ㆍ문법" />
					</div>
					<div class="modal-section">
						<label class="modal-label">저자</label>
						<input type="text" id="bookAuth1" name="bookAuth1" class="modal-input" value="윤혜정" />
					</div>
					<div class="modal-section">
						<label class="modal-label">출판사</label>
						<input type="text" id="bookPublisher1" name="bookPublisher1" class="modal-input" value="한국교육방송공사" />
					</div>
					<div class="modal-section">
						<label class="modal-label">정가</label>
						<input type="text" id="bookPrice1" name="bookPrice1" class="modal-input" value="17000" />
					</div>
					<div class="modal-section">
						<label class="modal-label">소비자가</label>
						<input type="text" id="bookPayPrice1" name="bookPayPrice1" class="modal-input" value="15300" />
					</div>
					<div class="modal-section">
						<label class="modal-label">발행일</label>
					...
					<div class="modal-section">
						<label class="modal-label">재고수량</label>
						<input type="text" id="invenQtt1" name="invenQtt1" class="modal-input" value="300" />
					</div>
