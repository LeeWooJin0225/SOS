	...
	/* $(document).ready(function(){
	   ...
	   $(document).ready(function(){
		      $("input[name='rating']").change(function(){
		         ...
		         if(rating == "T"){
		            document.getElementById("classCode").style.display = "block";
		            document.getElementById("userId").value = "tnsdlf09";
		            document.getElementById("userPwd1").value = "12341234";
		            document.getElementById("userPwd2").value = "12341234";
		            document.getElementById("userEmail").value = "rjsals0328@gmail.com";
		            document.getElementById("userName").value = "권순일";
		            document.getElementById("userPhone").value = "01087738409";
		            document.getElementById("addrCode").value = "04001";
		            document.getElementById("addrBase").value = "서울 마포구 월드컵북로 21";
		            document.getElementById("addrDetail").value = "풍성빌딩 2층 쌍용 교육 센터";            
		         }
		         else if(rating == "U"){
		            document.getElementById("classCode").style.display = "none";
		         }
		...
		<form name="joinForm" id="joinForm" method="post" action="/joinProc.jsp" class="form-signin">
			<div class="footer-innerBox">
				<div class="input_outBox">
					<div class="input_box">
						<input type="text" id="userId" name="userId" class="form_input" maxlength="20" required value="rjsals99">
				...
				<div class="input_outBox">
					<div class="input_box">
						<input type="text" id="userEmail" name="userEmail" class="form_input" required value="rjsals0328@naver.com">
				...
				<div class="input_box">
					<input type="password" id="userPwd1" name="userPwd1" class="form_input" maxlength="20" required value="12341234">
				...
				<div class="input_box">
					<input type="password" id="userPwd2" name="userPwd2" class="form_input" maxlength="20" required required value="12341234">
				...
				<div class="input_box">
					<input type="text" id="userName" name="userName" class="form_input" maxlength="20" required value="고건민">
				...
				<div class="input_box">
					<input type="text" id="userPhone" name="userPhone" class="form_input" maxlength="11" required value="01034495047">
				...
				<div class="input_outBox">
					<div class="input_box">
						<input type="text" id="addrCode" name="addrCode" class="form_input" maxlength="5" required value="04001">
				...
				<div class="input_box">
					<input type="text" id="addrBase" name="addrBase" class="form_input" maxlength="20" required value="서울 마포구 월드컵북로 21">
				...
				<div class="input_box">
					<input type="text" id="addrDetail" name="addrDetail" class="form_input" maxlength="20" required value="풍성빌딩 강북교육센터 2층">
